...
THEN execute immediate response: First Hour Response; Preserve all communications; Save transaction records; Preserve screenshots; Notify the bank; Report to Cyber Helpline; Register complaint on NCRP; Preserve website details
...
THEN pursue documented recovery measures: Account freezing, Fund trail analysis, Inter-bank coordination, Asset identification
```
...
THEN prepare charge sheet including: Documentary Evidence, Bank records, Website records, Domain registration records, Investment communications, Digital Evidence, Device reports, Communication logs, Server logs, Screenshots
...
THEN establish: False investment representation; Fraudulent inducement; Intent to deceive; Collection of funds through misrepresentation; Financial loss to victims; Digital linkage between accused and investment platform; Criminal benefit obtained by accused
```
