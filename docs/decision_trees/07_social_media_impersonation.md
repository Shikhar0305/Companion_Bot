...
THEN execute immediate response: First Hour Response; Preserve screenshots; Record profile URLs; Record usernames; Report account to platform; Inform affected contacts; Report through Cyber Helpline; Register complaint on NCRP
...
THEN prepare charge sheet including: Documentary Evidence, Complaint records, Platform responses, Screenshots, URLs, Digital Evidence, Account logs, IP records, Device reports, Communication records
...
THEN establish: False identity representation; Unauthorized use of victim identity; Intent to deceive or harm; Creation and operation of fake account; Digital linkage between accused and account; Harm suffered by victim; Benefit obtained by accused
```
